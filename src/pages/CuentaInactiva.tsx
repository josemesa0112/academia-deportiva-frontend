...
export default function CuentaInactiva() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[hsl(150,20%,6%)] p-4">
      <div className="max-w-md w-full rounded-2xl border border-amber-500/30 bg-[hsl(150,15%,10%)]/80 backdrop-blur-xl p-10 text-center shadow-2xl shadow-[hsl(38,80%,20%)]/30">
        ...
        <p className="text-sm text-[hsl(150,10%,70%)] mb-6">
        ...
        <p className="text-xs text-[hsl(150,10%,55%)] mb-8">
